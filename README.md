...
│ └─ support/
│ ├─ pages/
│ │ ├─ basePage.js # Base Page with helper methods
...
- Run Cypress interactive mode: npx cypress open

# Test Data

- Data store = cypress/fixtures/testdata.json
...
- Cypress 15+
- git
- Internet connection to access https://www.wiseadmit.io/applynow
